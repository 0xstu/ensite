...
const TransacationCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
  ...
  return (
    <div className='flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions'>
      ...
      {currentAccount ? (
        ...
        <h3 className='text-white text-3xl text-center my-2'>Connect your account to see your transactions</h3>
      )}
